package com.ultraplast.echrest.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("echallan");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("echallan");
        ...
        config.getMapConfigs().put("com.ultraplast.echrest.domain.*", initializeDomainMapConfig(jHipsterProperties));
